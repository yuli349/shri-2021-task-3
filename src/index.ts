...
import {
    createCurrentDataSelector, createCurrentIndexSelector, createProgressSelector, createThemeSelector,
} from './application/selectors';
import {
    initIframe, initProgress, sendMessage, setElementTheme, setScale,
